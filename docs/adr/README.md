...
88 ADRs total, across 14 `lua/tobira/` modules.
...
- 0117 — persisted-peak-average-for-forgotten-detection
...
- 0113 — buffer-local-seq-reset-with-ctrl-w-exemption
- 0114 — macro-dispatch-priority-generalization
- 0116 — macro-edit-keys-mode-source-distinction
- 0117 — persisted-peak-average-for-forgotten-detection
- 0118 — write-failure-must-not-advance-the-merge-baseline
...
- 0113 — buffer-local-seq-reset-with-ctrl-w-exemption
- 0114 — macro-dispatch-priority-generalization
- 0115 — prefix-consumer-streak-bookkeeping
- 0116 — macro-edit-keys-mode-source-distinction
- 0119 — diw-then-insert-text-object-variant-collapse

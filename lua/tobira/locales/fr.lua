return {
  ...
  float = {
    ...
    reasons = {
      ...
      j_repeat_wrapped = "Vous avez appuyé sur j 5 fois de suite sur une ligne qui s'enroule sur plusieurs lignes d'écran",
      ...
      k_repeat_wrapped = "Vous avez appuyé sur k 5 fois de suite sur une ligne qui s'enroule sur plusieurs lignes d'écran",

return {
  ...
  float = {
    ...
    reasons = {
      ...
      diw_then_insert = 'Borraste el objeto de texto de palabra interior y entraste en modo inserción',
      ...
      j_repeat_wrapped = 'Pulsaste j 5 veces seguidas en una línea que se envuelve en varias líneas de pantalla',
      ...
      k_repeat_wrapped = 'Pulsaste k 5 veces seguidas en una línea que se envuelve en varias líneas de pantalla',
  ...
  suggestions = {
    ...
    ['gw'] = {
      title = 'gw{motion} — reformatear texto sin mover el cursor',
      body = 'Igual que gq, pero el cursor vuelve a la posición inicial en vez de quedar al final del texto formateado\nÚtil si sueles saltar de vuelta con `` o <C-o> justo después de gq',
      example = 'gwap → se reformatea el párrafo, el cursor se queda donde estaba',
    },

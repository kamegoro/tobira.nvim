return {
  ...
  float = {
    example_prefix = 'z. B. ',
    close_hint = 'q/Esc/<C-c> schließen',
    ...
    reasons = {
      ...
      diw_then_insert = 'Du hast das innere Wort-Textobjekt gelöscht und bist in den Einfügemodus gewechselt',
      ...
      j_repeat_wrapped = 'Du hast 5-mal hintereinander j gedrückt, auf einer Zeile, die sich über mehrere Bildschirmzeilen umbricht',
      ...
      k_repeat_wrapped = 'Du hast 5-mal hintereinander k gedrückt, auf einer Zeile, die sich über mehrere Bildschirmzeilen umbricht',

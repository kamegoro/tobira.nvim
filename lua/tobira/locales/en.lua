return {
  ...
  float = {
    example_prefix = 'e.g. ',
    close_hint = 'q/Esc/<C-c> close',
    suppress_hint = ':TobiraProgress  x to mute',
    ...
    reasons = {
      ...
      indent_run = 'You indented the same way 3 times in a row',
      ...
      diw_then_insert = 'You deleted the inner word text object then entered insert mode',
      ...
      j_repeat_wrapped = 'You pressed j 5 times in a row on a line that wraps across multiple screen rows',
      ...
      k_repeat_wrapped = 'You pressed k 5 times in a row on a line that wraps across multiple screen rows',

...
-- A separate, much simpler state machine from seq/feed above. logger.lua only
-- calls feed_insert() while its mode cache says the user is in insert mode,
-- passing a canonical key name ('<BS>', '<Left>', '<Right>', '<Esc>') for the
-- keys this cares about, or nil for any other ordinary typed character.
--
